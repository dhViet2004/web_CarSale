...
export const metadata: Metadata = {
  title: 'HM',
  description: "Discover your dream car at 47HM's. Browse our exclusive collection of premium vehicles, schedule test drives, and experience exceptional service.",
  generator: 'Next.js',
  icons: {
